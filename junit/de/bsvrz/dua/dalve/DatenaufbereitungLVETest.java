...
public class DatenaufbereitungLVETest {
	 ...
	 * Verbindungsdaten
	 */
	public static final String[] CON_DATA_APP = new String[] {
			CON_DATA[0], 
			CON_DATA[1],
			CON_DATA[2],
	...
	/**
	 * Verzeichnis, in dem sich die CSV-Datei mit den Testdaten fuer virtuelle
	 * MQs befinden
	 */
	...
	public void testAnalyse() throws Exception {
		DaLVETestAnalyse analzseTest = new DaLVETestAnalyse(dav, alLogger,
				TEST_DATEN_VERZ);
