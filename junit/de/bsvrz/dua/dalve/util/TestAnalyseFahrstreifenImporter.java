 ...
 *
 */
public class TestAnalyseFahrstreifenImporter
extends CSVImporter{
	 ...
	 */
	public TestAnalyseFahrstreifenImporter(final ClientDavInterface dav, 
	...
	public final Data getDatensatz(final int FS){	
		Data datensatz = DAV.createData(DAV.getDataModel().getAttributeGroup(DUAKonstanten.ATG_KURZZEIT_FS));
