...
# Der absolute Pfad zum Projekt
export distroot=/home/vrz3/Datenverteiler/VRZ3BaWue

# Wenn die Variable gesetzt ist, wird das System getestet. Ist die Variable
# nicht da, die folgende Zeile also auskommentiert, dann befindet sich das
...
export passwortDatei=$distroot/skripte-bash/passwd

#  Die Variable 'jvmArgs' enthält die Standard-Aufrufargumente der Java Virtual Machine
export jvmArgs="-Dfile.encoding=ISO-8859-1 -Xms32m"
...
export debugDefaults="-debugFilePath=$distroot"
