...
/**
 * Korrespondiert mit einem Parameter fuer ein bestimmtes Verkehrsattribut
 * (also z.B. <code>qKfz</code> (<code>QKfz</code>) oder <code>vLkw</code>
 * (<code>VLkw</code>)) innerhalb der Attributgruppen:<br>
...
public class PrognoseAttributParameter {
	 ...
	 * @param fuerFahrStreifen ob die Daten fuer ein Fahrstreifenobjekt ausgelesen
	 * werden sollen
	 */
	public final void setDaten(final Data datum, 
							   final boolean fuerFahrStreifen){
		this.start = datum.getUnscaledValue(attribut.getParameterStart(fuerFahrStreifen)).longValue();
	...
	public boolean equals(Object obj) {
		...
		if(obj != null && obj instanceof PrognoseAttributParameter){
			...
			gleich = this.attribut.equals(that.attribut) &&
					 ...
					 this.alpha1 == that.alpha1 &&
					 this.alpha2 == that.alpha2 &&
					 this.beta1 == that.beta1 &&
