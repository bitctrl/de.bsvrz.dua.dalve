 ...
 */
public class ParaAnaProgImportFS
extends AbstractParaAnaProgImport {
	 ...
	 */
	public ParaAnaProgImportFS(final ClientDavInterface dav, 
	...
	throws Exception{
		...
		ATG_PrognoseFlink = DAV.getDataModel().getAttributeGroup("atg.verkehrsDatenKurzZeitTrendExtraPolationPrognoseFlinkFs"); //$NON-NLS-1$
		ATG_PrognoseNormal = DAV.getDataModel().getAttributeGroup("atg.verkehrsDatenKurzZeitTrendExtraPolationPrognoseNormalFs"); //$NON-NLS-1$
		ATG_PrognoseTraege = DAV.getDataModel().getAttributeGroup("atg.verkehrsDatenKurzZeitTrendExtraPolationPrognoseTrägeFs"); //$NON-NLS-1$
	...
	/* (non-Javadoc)
	 * @see de.bsvrz.dua.dalve.util.para.AbstractParaAnaProgImport#getAnalyseAttributPfadVon(java.lang.String, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.bsvrz.dua.dalve.util.para.AbstractParaAnaProgImport#setParaAnalyseWichtung(de.bsvrz.dav.daf.main.Data)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.bsvrz.dua.dalve.util.para.AbstractParaAnaProgImport#setParameterResult(de.bsvrz.dav.daf.main.Data, java.lang.String, java.lang.String)
	 */
	@Override
